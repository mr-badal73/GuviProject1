...
public class TeacherDetails extends JFrame implements ActionListener {
    private static final Logger LOGGER = Logger.getLogger(TeacherDetails.class.getName());
    ...
    private void handleSearch() {
        ...
        try {
            ...
            if (found) {
                showStatus("Teacher details found", false);
            } else {
                showStatus("No teacher found with employee ID: " + selectedEmpId, true);
            }
            pstmt.close();
        } catch (SQLException e) {
            LOGGER.log(Level.SEVERE, "Error searching teacher details", e);
            showStatus("Error searching teacher details: " + e.getMessage(), true);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new TeacherDetails());
    }
}
